...
function integrateWasmJS() {
    ...
    var wasmBinaryFile = "webcam-barcode-scanner.worker.wasm"; // "a.out.wasm";
...
STATICTOP = STATIC_BASE + 136976;
__ATINIT__.push();
var STATIC_BUMP = 136976;
...
function _js_output_result(symbol, data, polygon, polygon_size) {
    ...
    const flatCoords = new Int32Array(resultView);
    const coordinates = flatCoords;
